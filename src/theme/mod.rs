...
pub use crate::theme::{app_theme::AppTheme, radius::RadiusScale, spacing::SpacingScale};
...
pub static CAT_THEME: LazyLock<AppTheme> =
    LazyLock::new(|| AppTheme::new(SpacingScale::DEFAULT, RadiusScale::DEFAULT));
